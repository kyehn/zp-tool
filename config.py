...
class Config:
    ...
    BASE_URL = _URLs.BASE_URL
    JOB_URL = _URLs.JOB_URL
    CITY_API_URL = _URLs.CITY_API_URL
    JOB_CARD_API_URL = _URLs.JOB_CARD_API_URL
    JOB_DETAIL_API_URL = _URLs.JOB_DETAIL_API_URL
    JOB_DETAIL_URL = _URLs.JOB_DETAIL_URL
    JOBLIST_API_URL = _URLs.JOBLIST_API_URL
    VERIFY_SLIDER_URL = _URLs.VERIFY_SLIDER_URL
    LOGIN_URL = _URLs.LOGIN_URL
    MASK_COMPANY_URL = _URLs.MASK_COMPANY_URL
    INTERACTION_URL = _URLs.INTERACTION_URL
    RESUME_URL = _URLs.RESUME_URL

    TIMEOUT_SECONDS: int = 25
    SMALL_SLEEP_SECONDS: float = 1.2
    LARGE_SLEEP_SECONDS: float = 6
